...
def main():
    ...
    if not os.path.exists(YOLO_MODEL_PATH):
        ...
        print(f"Run first: python yolo_training/train_yolo.py")
        return
    ...
    # MediaPipe Hand Landmarker (for hand detection and cropping)
    ...
    print("YOLO detection started. Q - exit")
    ...
    with HandLandmarker.create_from_options(options) as landmarker:
        while True:
            ...
            cv2.imshow('YOLO Gesture Detection - Q: exit', frame)
